...
#define ELOG_EVENT_ID_STARTED_FACTORY_RESET_BY_PUSH_KEY (0xb003)
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtn_InitialValueOfGlobalVariable(void **state)
{
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_FullySuccess(void **state)
{
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerOpen(void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterPressedCallback(void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterReleasedCallbackFor5to29(
    void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterReleasedCallbackFor30Over(
    void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterLongPressedCallbackFor5(
    void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterLongPressedCallbackFor30(
    void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnInitialize_ErrorEsfButtonManagerEnableNotificationCallback(void **state)
{
    EsfButtonManagerHandle handle_val = (EsfButtonManagerHandle)0x12345678;
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnFinalize_FullySuccess(void **state)
{
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnFinalize_ErrorEsfButtonManagerDisableNotificationCallback(void **state)
{
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnFinalize_ErrorEsfButtonManagerUnregisterLongPressedCallback(void **state)
{
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnFinalize_ErrorEsfButtonManagerUnregisterReleasedCallback(void **state)
{
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnFinalize_ErrorEsfButtonManagerUnregisterPressedCallback(void **state)
{
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnFinalize_ErrorEsfButtonManagerClose(void **state)
{
    RetCode ret;
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnCheckRebootRequest(void **state)
{
    bool ret;

    s_reboot_requested = true;
    ret = SysAppBtnCheckRebootRequest();
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnCheckFactoryResetRequest(void **state)
{
    bool ret;

    s_factory_reset_requested = true;
    ret = SysAppBtnCheckFactoryResetRequest();
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnExecuteFactoryResetCore_FullySuccess(void **state)
{
    RetCode ret;
    ...
    ret = SysAppBtnExecuteFactoryResetCore();
...
/*----------------------------------------------------------------------------*/
static void test_SysAppBtnExecuteFactoryResetCore_ErrorEsfFwMgrStartFactoryReset(void **state)
{
    RetCode ret;
...
static void test_ButtonReleased5to29Callback_FullySuccess(void **state)
{
    ...
    expect_value(__wrap_EsfSystemManagerSetQrModeTimeoutValue, data, 180);
...
static void test_ButtonReleasedOver30Callback_ExecFactoryReset(void **state)
{
    ...
    will_return(__wrap_SysAppDcmdCheckSelfTerminate, UnDefined);
    ...
    expect_value(__wrap_UtilityLogWriteELog, event_id,
                 ELOG_EVENT_ID_STARTED_FACTORY_RESET_BY_PUSH_KEY);
...
/*----------------------------------------------------------------------------*/
static void test_ButtonReleasedOver30Callback_AlreadyDcFcWorking(void **state)
{
    s_factory_reset_requested = false;
...
/*----------------------------------------------------------------------------*/
static void test_ButtonReleasedOver30Callback_AlreadyRebootWorking(void **state)
{
    s_factory_reset_requested = false;
...
int main(void)
{
    const struct CMUnitTest tests[] = {
        // Initial value check for static global variable
        cmocka_unit_test(test_SysAppBtn_InitialValueOfGlobalVariable),

        // SysAppBtnInitialize()
        cmocka_unit_test(test_SysAppBtnInitialize_FullySuccess),
        cmocka_unit_test(test_SysAppBtnInitialize_ErrorEsfButtonManagerOpen),
        cmocka_unit_test(test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterPressedCallback),
        cmocka_unit_test(
            test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterReleasedCallbackFor5to29),
        cmocka_unit_test(
            test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterReleasedCallbackFor30Over),
        cmocka_unit_test(
            test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterLongPressedCallbackFor5),
        cmocka_unit_test(
            test_SysAppBtnInitialize_ErrorEsfButtonManagerRegisterLongPressedCallbackFor30),
        cmocka_unit_test(test_SysAppBtnInitialize_ErrorEsfButtonManagerEnableNotificationCallback),

        // SysAppBtnFinalize()
        cmocka_unit_test(test_SysAppBtnFinalize_FullySuccess),
        cmocka_unit_test(test_SysAppBtnFinalize_ErrorEsfButtonManagerDisableNotificationCallback),
        cmocka_unit_test(test_SysAppBtnFinalize_ErrorEsfButtonManagerUnregisterLongPressedCallback),
        cmocka_unit_test(test_SysAppBtnFinalize_ErrorEsfButtonManagerUnregisterReleasedCallback),
        cmocka_unit_test(test_SysAppBtnFinalize_ErrorEsfButtonManagerUnregisterPressedCallback),
        cmocka_unit_test(test_SysAppBtnFinalize_ErrorEsfButtonManagerClose),

        // SysAppBtnCheckRebootRequest()
        cmocka_unit_test(test_SysAppBtnCheckRebootRequest),

        // SysAppBtnCheckFactoryResetRequest()
        cmocka_unit_test(test_SysAppBtnCheckFactoryResetRequest),

        // SysAppBtnExecuteFactoryResetCore()
        cmocka_unit_test(test_SysAppBtnExecuteFactoryResetCore_FullySuccess),
        cmocka_unit_test(test_SysAppBtnExecuteFactoryResetCore_ErrorEsfFwMgrStartFactoryReset),
        ...
        cmocka_unit_test(test_ButtonReleasedOver30Callback_AlreadyDcFcWorking),
        cmocka_unit_test(test_ButtonReleasedOver30Callback_AlreadyRebootWorking),
