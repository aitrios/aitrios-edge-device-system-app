                                            ...
                                            void* value, size_t value_size)
{
    ...
    if (strcmp(property_key, SENSCORD_IMAGE_PROPERTY_KEY) == 0) {
        *(struct senscord_image_property_t*)value = *(mock_type(struct senscord_image_property_t*));
    }
                                            ...
                                            const void* value, size_t value_size)
{
    ...
    if (strcmp(property_key, SENSCORD_AI_MODEL_BUNDLE_ID_PROPERTY_KEY) == 0) {
        ...
        struct senscord_image_crop_property_t* crop = (struct senscord_image_crop_property_t*)value;
