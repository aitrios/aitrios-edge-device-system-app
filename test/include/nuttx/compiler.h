...
// If CONFIG_FORTIFY_SOURCE is larger than 0, build warning occurs in unit test.
// And this section defines about fortify, is not related to unit test.
// To prevent Unit Test build warning, disable below. 
#if 0
